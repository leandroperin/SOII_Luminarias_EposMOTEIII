...
extern "C" { void _dispatch(unsigned int id) __attribute__ ((alias("_ZN4EPOS1S11Cortex_M_IC8dispatchEj"))); }
extern "C" { void _int_entry() __attribute__ ((alias("_ZN4EPOS1S11Cortex_M_IC5entryEv"))); }
extern "C" { void _eoi() __attribute__ ((alias("_ZN4EPOS1S11Cortex_M_IC3eoiEj"))); }

__BEGIN_SYS

// Class attributes
Cortex_M_IC::Interrupt_Handler Cortex_M_IC::_int_vector[Cortex_M_IC::INTS];
Cortex_M_IC::Interrupt_Handler Cortex_M_IC::_eoi_vector[Cortex_M_IC::INTS];
...
void Cortex_M_IC::eoi(unsigned int id)
{
    if(_eoi_vector[id])
        _eoi_vector[id](id);
}
